...
keymap('n', '<A-h>', ":lua require('smart-splits').move_cursor_left()<CR>", opts)
keymap('n', '<A-j>', ":lua require('smart-splits').move_cursor_down()<CR>", opts)
keymap('n', '<A-k>', ":lua require('smart-splits').move_cursor_up()<CR>", opts)
keymap('n', '<A-l>', ":lua require('smart-splits').move_cursor_right()<CR>", opts)
